...
% save ('F:\CS of HSI partitioned\results\dc\0.05\xrec_ttv', 'xrec_ttv');
% save ('F:\CS of HSI partitioned\results\dc\0.05\index_ttv',' everyindex_ttv',' outindex_ttv',' globalpsnr_ttv', 'ergas_ttv' ,'msam_ttv');
...
% save ('F:\CS of HSI partitioned\results\dc\0.05\xrec_rettv', 'xrec_rettv');
% save ('F:\CS of HSI partitioned\results\dc\0.05\index_rettv',' everyindex_rettv',' outindex_rettv',' globalpsnr_rettv', 'ergas_rettv' ,'msam_rettv');
