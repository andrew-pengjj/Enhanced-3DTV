...
% signals with tensor product sparsity
%
% Usage: w = At_cscamtensor(b, OMEGA, idx, P, h)
%
...
% h - Wavelet filter
%
% w - N^2*S coefficient vector for x(t)
%
...
function [w,x,tmp,bm] = At_cscamtensor(b, OMEGA, idx, P, h)
