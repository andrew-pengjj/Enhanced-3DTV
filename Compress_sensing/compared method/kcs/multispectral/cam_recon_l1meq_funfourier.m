...
function estIm = cam_recon_l1meq_funfourier(coeffs, pkeep, sidelength);
...
h = daubcqf(8);
Af = @(z) A_cscamtensorfourier(z, OMEGA, idx, permx, h);
Ab = @(z) At_cscamtensorfourier(z, OMEGA, idx, permx, h);
